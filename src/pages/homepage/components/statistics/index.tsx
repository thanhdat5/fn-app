            ...
            <Row>
                <Col lg="9">
                    <div className="line">
                        ...
                        <span>{t('Total tickets')}: {loggedUser?.totalTickets}</span>
                    </div>
                    <div className="line">
                        <img src="/images/icons/winning.svg" alt="" />
                        <span>{t('Total winning tickets')}: {loggedUser?.totalWinningTickets}</span>
                    </div>
                </Col>
                <Col lg="3">
                    <div className="line">
                        <img src="/images/icons/prize.svg" alt="" />
                        <span>{t('Total winning tickets')}: {loggedUser?.totalPrizeWon}</span>
                    </div>
                </Col>
            </Row>
        </div>
